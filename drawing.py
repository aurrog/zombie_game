...
def drawing(screen, map, player, zombie, bullets):
    ...
    if zombie.is_alive:
        ...
        pygame.draw.rect(screen, RED, (zombie.x-20, zombie.y+15, 40, 10))
        pygame.draw.rect(screen, GREEN, (zombie.x-20, zombie.y+15, zombie.lives*10, 10))
        pygame.draw.circle(screen, (0, 200, 100), zombie.pos, 2)
